...
from StyleSDF.volume_renderer import VolumeFeatureRenderer
from StyleSDF.op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d
...
class Generator(nn.Module):
    ...
    def forward(self, styles, cam_poses, focals, near=0.88, far=1.12, return_latents=False,
                ...
                project_noise=False, mesh_path=None, weights_delta=None):
        ...
        with torch.set_grad_enabled(self.is_train and self.train_renderer):
            ...
            thumb_rgb, features, sdf, mask, xyz, eikonal_term = self.renderer(cam_poses, focals, near, far, styles=latent[0], return_eikonal=return_eikonal, weights_delta=weights_delta)
